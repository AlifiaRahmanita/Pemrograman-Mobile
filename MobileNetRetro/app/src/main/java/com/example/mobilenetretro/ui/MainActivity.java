package com.example.mobilenetretro.ui;
...
import com.example.mobilenetretro.data.response.Restaurant;
import com.example.mobilenetretro.data.response.RestaurantResponse;
import com.example.mobilenetretro.data.retrofit.ApiConfig;
import com.example.mobilenetretro.data.retrofit.PostReviewResponse;
import com.example.mobilenetretro.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void postReview(String review) {
        showLoading(true);
        Call<PostReviewResponse> client =
                ApiConfig.getApiService().postReview(RESTAURANT_ID, "Alipp",
                        review);
        client.enqueue(new Callback<PostReviewResponse>() {
            @Override
            public void onResponse(@NotNull Call<PostReviewResponse> call,
                                   @NotNull Response<PostReviewResponse> response) {
                showLoading(false);
            ...
            @Override
            public void onFailure(@NotNull Call<PostReviewResponse> call,
                                  @NotNull Throwable t) {
                showLoading(false);
