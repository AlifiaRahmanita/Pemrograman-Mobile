...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Inisialisasi objek editTitle dan editContent di sini
        editTitle = findViewById(R.id.edit_title); // Sesuaikan dengan ID yang sesuai di layout XML
        editContent = findViewById(R.id.edit_file); // Sesuaikan dengan ID yang sesuai di layout XML
    ...
    private void loadData(String title) {
        FileModel fileModel = FileHelper.readFromFile(this,
                title);
        editTitle.setText(fileModel.getFilename());
        editContent.setText(fileModel.getData());
        Toast.makeText(this, "Loading " + fileModel.getFilename()
    ...
    private void saveFile() {
        if (editTitle.getText().toString().isEmpty()) {
            ...
            Toast.makeText(this, "Saving " +
                    fileModel.getFilename() + " file", Toast.LENGTH_SHORT).show();
        }
    }
}